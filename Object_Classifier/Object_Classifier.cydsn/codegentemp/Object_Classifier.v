// ======================================================================
// Object_Classifier.v generated from TopDesign.cysch
// 01/03/2023 at 18:00
...
module CapSense_P4_v7_0_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("435a9b0f-39e7-4e9a-88ac-1b946d0ef982/77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .pa_out_clock_en(-1),
		  .pa_out_reset(-1),
		  .pin_aliases("Button0_Sns0,Button1_Sns0"),
		  .pin_mode("AA"),
		  .por_state(4),
		  .sio_group_cnt(0),
		  .sio_hyst(2'b1_1),
	...
	cy_psoc3_pins_v1_10
		#(.id("435a9b0f-39e7-4e9a-88ac-1b946d0ef982/7850aeaf-db25-4eae-b828-015ef596b59e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("435a9b0f-39e7-4e9a-88ac-1b946d0ef982/a8285cdc-5e81-40c0-8036-58ea5f8c1102"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("1ce9609b-158c-441f-8765-40810446898b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("07c5aca1-bb0c-40e1-98d2-f17c4291f068"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bc0df6c3-e0cd-4bb5-9a7c-60b83323350a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("498d2e03-00b9-4b95-b449-0819a111400b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("f10a889f-70ca-421f-a100-8a011ced78a0"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("2000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Pin_to_servo_net;
	wire [0:0] tmpFB_0__Pin_to_servo_net;
	wire [0:0] tmpIO_0__Pin_to_servo_net;
	wire [0:0] tmpINTERRUPT_0__Pin_to_servo_net;
	electrical [0:0] tmpSIOVREF__Pin_to_servo_net;

	cy_psoc3_pins_v1_10
		#(.id("77f8c415-f6fc-4c61-b56a-6850b814482d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_to_servo
		 (.oe(tmpOE__Pin_to_servo_net),
		  .y({Net_44}),
		  .fb({tmpFB_0__Pin_to_servo_net[0:0]}),
		  .io({tmpIO_0__Pin_to_servo_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_to_servo_net),
		  .interrupt({tmpINTERRUPT_0__Pin_to_servo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_to_servo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
